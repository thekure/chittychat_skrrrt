...
type TimeAskServiceClient interface {
	GetTime(ctx context.Context, in *AskForTimeMessage, opts ...grpc.CallOption) (*TimeMessage, error)
}
...
func (c *timeAskServiceClient) GetTime(ctx context.Context, in *AskForTimeMessage, opts ...grpc.CallOption) (*TimeMessage, error) {
	out := new(TimeMessage)
...
type TimeAskServiceServer interface {
	GetTime(context.Context, *AskForTimeMessage) (*TimeMessage, error)
...
func (UnimplementedTimeAskServiceServer) GetTime(context.Context, *AskForTimeMessage) (*TimeMessage, error) {
...
func _TimeAskService_GetTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TimeAskServiceServer).GetTime(ctx, req.(*AskForTimeMessage))
	}
